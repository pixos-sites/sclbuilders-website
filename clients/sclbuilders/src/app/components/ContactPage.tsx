...
export function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch("https://api.web3forms.com/submit", {
      ...
      body: JSON.stringify({
        ...
        subject: "New Enquiry from SCL Builders Website",
        ...formData,
      }),
    });
  ...
  const contactInfo = [
    { icon: Phone, label: "Mobile", value: "07866 939663", href: "tel:07866939663" },
    { icon: Phone, label: "Office", value: "01698 711162", href: "tel:01698711162" },
    { icon: Mail, label: "Email", value: "stephen@sclbuilders.com", href: "mailto:stephen@sclbuilders.com" },
    { icon: MapPin, label: "Address", value: "116 High Blantyre Rd, Hamilton ML3 9HW", href: null },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
            ...
            <p className="m-0 mx-auto" style={{ fontSize: "16px", color: "#9CA3AF", maxWidth: "520px", lineHeight: 1.7 }}>
              Free quotation, full design service included — no obligation. Get in touch and we'll get back to you promptly.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="lg:col-span-2">
              ...
              <div className="mt-8 p-6 rounded-2xl" style={{ backgroundColor: NAVY }}>
                <h4 className="m-0 mb-2 text-white" style={{ fontSize: "16px", fontWeight: 700 }}>Speak to Stephen directly</h4>
                <p className="m-0 mb-4" style={{ fontSize: "13px", color: "#9CA3AF", lineHeight: 1.6 }}>
                  Call us during business hours and we'll discuss your project straight away. Free design service included with every quote.
                </p>
                <a href="tel:07866939663" className="inline-flex items-center gap-2 px-5 py-3 no-underline rounded-xl transition-all duration-200 hover:scale-105" style={{ backgroundColor: GOLD, color: NAVY, fontSize: "14px", fontWeight: 700 }}>
                  <Phone size={16} />07866 939663
                </a>
              </div>
            </motion.div>
